...
- **Very Important!** Ensure the `word_list.py` module exists in the same folder and exposes a `words` variable (a list of strings).
...
You will get a scrambled food-related word.

You will be able to guess the correct word until you succeed/quit.
